...
sudo osbuild --store _build/osbuild_store --output-directory _build/image_output --checkpoint image-tree --checkpoint image --cache-max-size 20GiB --export images _build/silverblue-asahi-container.aarch64.json
