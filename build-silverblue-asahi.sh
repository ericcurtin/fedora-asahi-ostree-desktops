...
sudo osbuild --store /var/osbuild/store/ --output-directory out/ --checkpoint image-tree --checkpoint image --cache-max-size 20GiB --export qcow2 _build/silverblue-asahi-container.aarch64.json
